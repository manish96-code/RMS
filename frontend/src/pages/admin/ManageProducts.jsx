        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-200">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              View, filter and manage live dishes in the restaurant menu ({dishes.length} items)
            </p>
          </div>
                      ...
                      <tr key={dish.id} className="hover:bg-slate-50/80 transition">
                        ...
                        <td className="px-4 py-3.5 text-right">
                          <button
                            ...
                            className="px-2.5 py-1 bg-rose-50 text-rose-600 hover:bg-rose-100 rounded text-xs font-semibold transition cursor-pointer"
                          >
                            Delete
                          </button>
                        </td>
